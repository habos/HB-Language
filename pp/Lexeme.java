public class Lexeme {
	...
	public enum Type{
		BOOLEAN, CALL, STAT, HEADER, IFBLOCK, FUNCLIST, PROGRAM, LIST, VARLIST, ENV, TAB, ID, VAL, FUNCTION, VAR, AT, INCLUDE, NOT_EQUAL, ASSIGN, STRUCT, DOT, OPAREN, CPAREN, UNKNOWN, IF, FOR, WHILE, ELSE, VARIABLE, STRING, NUMBER, OBRACKET, CBRACKET, SEMICOLON, COMMA, ENDofINPUT, PLUS, MINUS, MULTIPLY, DIVISION, GREATER_THAN, LESS_THAN, MODULO, EQUAL, OBRACE, CBRACE, NOT, OR, AND;
	}
